...
// Flags for whether DRAM readings are available, and whether the units differ.
int dram_avail, different_units;
...
/*
  Open the MSR (Model-Specific Register) channel and return a file descriptor
*/
...
/*
  Read the value at the specified MSR using the fd opened by `open_msr()`
*/
...
/*
  Use the set of #defines, above, to look for the model of the CPU. Opens and
  reads /proc/cpuinfo.
*/
int detect_cpu(void) {
  FILE *file;
...
/*
  Initialize the RAPL system. Detect the CPU so as to set the globals that
  dictate what can be measured, and show some info if requested to do so.
*/
...
/*
  Show power limit info on the CPU
*/
...
/*
  Take RAPL readings prior to the execution of an experiment
*/
...
/*
  Take the RAPL readings after the completion of the experiment
*/
