...
int main(int argc, char **argv) {
  ...
  // Run the provided experiment `run_count` times, plus an initial run to
  // "prime" the disk cache of the data files to prevent that from affecting
  // the overall time of the first run. If the `-s` option was passed, this
  // initial run is skipped.
